...
function Header({ navigation }) {
  ...
  return (
    <header
      className={clsx(
        'bgx-white sticky top-0 z-50 flex flex-none flex-wrap items-center justify-between px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8',
        isScrolled
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
          <Logo className="h-6 w-auto fill-slate-700 dark:fill-sky-100" />
        </Link>
      </div>
